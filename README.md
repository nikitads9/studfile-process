...
А еще эта программа заменяет все изображения в docx файлоах на мем с Гуриковым С.Р., если в пути к этим файлам присутствуют слова `"Основы Программирования"` или `"Информатика"`
Основной use-case -- анонимизация своих Word файлов. Или просто для лулзов. 

## Инструкция по запуску:

<p align="justify">
- Если запускать бинарник, то нужно, чтобы рядом с **main.exe** была папка **МТУСИ**, а в ней нужные файлы.
- Если запускать через командную строку, то команда: 
  
  ``` 
  start main.exe -Labs "ПУТЬ до папки, которую будем перелопачивать"
  ```
- архиважно, чтобы рядом с **main.exe** лежал **dict.json**
...
Рекомендую добавлять несколько вариантов, так как зачастую ппрограмма улавливает только фамилию без инициалов, к тому же нужно учесть букву `ё`.
 ...
 <img  src="./file_walker/гуриков.png" width="100%">
