...
А еще она заменяет все изображения в docx файлах на мем с Гуриковым С.Р., если в пути к этим файлам присутствуют слова  ` Основы Программирования` или `Информатика`
